---
layout: default
title: Isiah Jones C-AI/MLPen, GICSP, CISSP, Pentest+ce
---

# Security Methodology

Welcome to the official website for my security tools, templates, and research.

## About This Project

This site hosts the documentation for the resources found in my [GitHub repository](https://github.com/isiahjonesSTEM/security-methodology).

- [AI Tools and Research](https://github.com/isiahjonesSTEM/security-methodology/tree/main/AI_Tools_Research)
- [Command Line Tools and Scripts](https://github.com/isiahjonesSTEM/security-methodology/tree/main/Commands_Scripts)
- [Papers, Guides and Reports](https://github.com/isiahjonesSTEM/security-methodology/tree/main/Papers_Guides_Reports)
...
👉 [**View all sponsorship tiers and project services →**](/pricing)  
🔁 [**Manage your subscription →**](/manage) *(for existing monthly subscription sponsors)*
